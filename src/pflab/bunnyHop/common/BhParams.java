...
public class BhParams {
	...
	public static double nodeScale = 0.8 * Util.rem;
	...
	public static int numMaxUndoTimes = 128;	//!< undo 可能な最大回数
	public static int numMaxBottomTextAreaChars = 4096;	//!< 下部テキストエリアの最大表示文字数
	...
	public static int rmiTCPPort = Registry.REGISTRY_PORT;	//!< RMIレジストリサーバにアクセスする際のTCPポート
	public static int numRmiRetry = 2;	//!< RMIオブジェクトの処理に失敗した際のリトライ回数
	...
	public static class Fxml {
		...
		public static String idUserOperationController = "userOperationController";
