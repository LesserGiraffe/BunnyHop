...
public class Workspace implements MsgSender, Serializable {
	...
	private final SortedSet<BhNode> rootNodeList = new TreeSet<>((Comparator<BhNode> & Serializable)(a, b) -> {return a.hashCode() - b.hashCode();});	//!< ワークスペースのルートノードのリスト
	private final SortedSet<BhNode> selectedList = new TreeSet<>((Comparator<BhNode> & Serializable)(a, b) -> {return a.hashCode() - b.hashCode();});	//!< 選択中のノード
	 ...
	 */
	public SortedSet<BhNode> getSelectedNodeList() {
		return selectedList;
	}
	...
	public void clearSelectedNodeList(UserOperationCommand userOpeCmd) {
		while (!selectedList.isEmpty()) {
			removeSelectedNode(selectedList.first(), userOpeCmd);
		}
	}
