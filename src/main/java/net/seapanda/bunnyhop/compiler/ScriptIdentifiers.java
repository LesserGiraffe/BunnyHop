...
public class ScriptIdentifiers {
  ...
  public static class Funcs {
    ...
    public static final String LIST_PUSH = "_listPush";
    public static final String LIST_INSERT = "_listInsert";
    public static final String LIST_REMOVE = "_listRemove";
    public static final String LIST_EXTRACT = "_listExtract";
    public static final String LIST_SLICE = "_listSlice";
    public static final String LIST_INSERT_ALL = "_listInsertAll";
    public static final String LIST_GET = "_listGet";
    public static final String LIST_SET = "_listSet";
    public static final String LIST_LEN = "_listLen";
    public static final String LIST_REVERSE = "_listReverse";
    public static final String LIST_REVERSED = "_listReversed";
    public static final String LIST_FIRST_INDEX_OF = "_listFirstIndexOf";
    public static final String LIST_LAST_INDEX_OF = "_listLastIndexOf";
    public static final String LIST_INCLUDES = "_listIncludes";
    public static final String LIST_EQ = "_listEq";
    public static final String LIST_NEQ = "_listNeq";
    public static final String LIST_MAX = "_listMax";
    public static final String LIST_MIN = "_listMin";
    public static final String LIST_NUM_MAX = "_listNumMax";
    public static final String LIST_NUM_MIN = "_listNumMin";
    public static final String LIST_SORT = "_listSort";
    public static final String LIST_SORTED = "_listSorted";
    public static final String LIST_NUM_SORT = "_listNumSort";
    public static final String LIST_NUM_SORTED = "_listNumSorted";
