...
public class BhParams {
  ...
  public static class LnF {
    ...
    public static final double REPLACED_NODE_SHIFT = 2.5 * BhParams.LnF.NODE_SCALE;
    /** BhNode 選択パネル上での BhNode 間のスペース. */
    public static final double BHNODE_SPACE_ON_SELECTION_PANEL = 2.0 * BhParams.LnF.NODE_SCALE;
    /** マルチノードシフタの大きさ. */
  ...
  public static class BhModelDef {
    ...
    public static final String ATTR_ON_VIEW_CONTENTS_CREATING = "onViewContentsCreating";
