  ...
  public List<Double> createVertices(
    ...
    if (pos == ConnectorPos.LEFT) {
      ...
      vertices = new ArrayList<>(Arrays.asList(
        ...
        offsetX + width * (ofsX + rate * 0.424733), offsetY + height * (ofsY + rate * 0.308587),
        offsetX + width * (ofsX + 0.162233),        offsetY + height * (ofsY + 0.499304),
        offsetX + width * (ofsX - rate * 0.162233), offsetY + height * (ofsY + rate * 0.499304),
      ...
      vertices = new ArrayList<>(Arrays.asList(
          ...
          offsetX + width * (ofsX - rate * 0.308587), offsetY + height * (ofsY + rate * 0.424733),
          offsetX + width * (ofsX - 0.499304),        offsetY + height * (ofsY + 0.162233),
          offsetX + width * (ofsX - rate * 0.499304), offsetY + height * (ofsY - rate * 0.162233),
