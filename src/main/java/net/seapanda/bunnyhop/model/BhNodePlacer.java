...
import net.seapanda.bunnyhop.model.node.derivative.DerivativeCollector;
import net.seapanda.bunnyhop.model.node.derivative.DerivativeRemover;
...
public class BhNodePlacer {
   ...
   *         </pre>
   */
  public static SequencedSet<Swapped> moveToWs(
      Workspace ws,
      BhNode node,
      double x,
      double y,
   ...
   *         </pre>
   */
  public static SequencedSet<Swapped> replaceChild(
