 ...
 * @author K.Koike
 */
public class DerivativeTextSetter implements BhNodeWalker {

  /**
   * {@code node} で指定したノード以下の {@link TextNode} 型の派生ノードに, そのオリジナルノードのテキストをセットする.
   */
  public static void set(BhNode node) {
    node.accept(new DerivativeTextSetter());
  }

  private DerivativeTextSetter() {}
