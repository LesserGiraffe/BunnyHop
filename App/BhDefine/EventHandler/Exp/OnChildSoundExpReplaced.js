(function() {
  ...
  // 音削除
  if (String(bhReplacedNewNode.getSymbolName()) === 'SoundExpVoid') {
    if (String(nextMelodyExp.getSymbolName()) === 'MelodyExp') {
      bhNodePlacer.moveToWs(bhThis.getWorkspace(), nextMelodyExp, 0, 0, bhUserOpe);
  ...
  // 音挿入
    ...
    // bhReplacedOldNode が SoundExpVoid の場合この時点で削除されている.
