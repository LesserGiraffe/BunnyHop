...
public class ExpCodeGenerator {
	...
	private String genBinaryExp(
		...
		String funcName = SymbolNames.PreDefFunc.preDefFuncNameMap.get(new AbstractMap.SimpleEntry(SymbolNames.PreDefFunc.isFinite, null));
	...
	public String genPreDefFuncCallExp(
		...
		SyntaxSymbol argExp = funcCallNode.findSymbolInDescendants("*",	SymbolNames.PreDefFunc.option, "*");
		String callOption = null;
		if (argExp instanceof TextNode)
			callOption = ((TextNode)argExp).getText();
		...
		String funcName = SymbolNames.PreDefFunc.preDefFuncNameMap.get(
			new AbstractMap.SimpleEntry(funcCallNode.getSymbolName(), callOption));
	...
	private String genArrayGetExp(
		...
		SyntaxSymbol arayExp = arrayGetNode.findSymbolInDescendants("*", SymbolNames.Array.array, "*");
		...
		String indexExpCode = genExpression(code, indexExp, nestLevel, option);
		...
		String funcName = SymbolNames.PreDefFunc.preDefFuncNameMap.get(new AbstractMap.SimpleEntry(arrayGetNode.getSymbolName(), null));
